...
namespace SimplestApp.Persistence.EntityFramework
{
    class Program
    {
        private static void Main(string[] args)
        {
            ...
            serviceCollection.AddDbContext<TutotrialDDDDbContext>(options =>
                options.UseSqlite("Data Source=samplesdb_dev.sqlite;"));

            serviceCollection.AddSingleton(new TutorialDDDDbContext("Filename=sample_projection.db;Connection=shared"));
